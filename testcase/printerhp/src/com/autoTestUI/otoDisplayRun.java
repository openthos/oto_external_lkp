...
public class otoDisplayRun extends UiAutomatorTestCase{
	...
	private void SolveProblems(){
		...
		boolean diagnosticsExists = new UiObject(
				new UiSelector().resourceId("com.hp.android.print:id/diagnostics_and_usage_activate_btn_done")).exists();
		boolean promotionExists = new UiObject(
				new UiSelector().resourceId("com.hp.android.print:id/btn_got_it")).exists();	
		if (diagnosticsExists == true) {
			System.out.println("diagnostics exists");
			UiObject skipButton = new UiObject(
					new UiSelector().resourceId("com.hp.android.print:id/diagnostics_and_usage_activate_btn_done"));
			try {
				skipButton.click();
			} catch (UiObjectNotFoundException e) {
				// TODO Auto-generated catch block
		...
		if (promotionExists == true) {
			...
			UiObject skipButton = new UiObject(
					new UiSelector().resourceId("com.hp.android.print:id/btn_got_it"));
			try {
				skipButton.click();
			} catch (UiObjectNotFoundException e) {
				// TODO Auto-generated catch block
