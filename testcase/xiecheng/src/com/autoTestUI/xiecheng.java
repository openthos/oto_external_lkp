...
public class xiecheng extends UiAutomatorTestCase {
	...
	public static String appactivity = "ctrip.business.splash.CtripSplashActivity";
	public static String appName = "ctrip.android.view/ctrip.business.splash.CtripSplashActivity";
