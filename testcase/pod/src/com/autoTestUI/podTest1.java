...
public class podTest1 extends UiAutomatorTestCase{
	//public static String apppackage = "com.skype.raider";
	public static String appName = "com.bambuna.podcastaddict/.activity.PodcastListActivity";
	public static String port = "5555";

	public void testpod() throws UiObjectNotFoundException, RemoteException,
