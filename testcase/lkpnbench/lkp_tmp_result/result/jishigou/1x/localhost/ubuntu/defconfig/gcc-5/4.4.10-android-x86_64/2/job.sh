...
export_top_env()
{
	...
	export enqueue_time='2016-11-10 23:13:23 +0800'
	export testbox='localhost'
	export tbox_group='localhost'
	export kconfig='defconfig'
	export commit='4.4.10-android-x86_64'
...
run_job()
{
	...
	export duration='10s'
	run_test $LKP_SRC/tests/wrapper jishigou
	unset duration
...
extract_stats()
{
	...
	$LKP_SRC/stats/wrapper time jishigou.time
