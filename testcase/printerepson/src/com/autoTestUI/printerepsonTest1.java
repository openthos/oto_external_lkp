...
public class printerepsonTest1 extends UiAutomatorTestCase {

	public static String apppackage = "epson.print";
	public static String appName = "epson.print/.WellcomeScreenActivity";
	public static String port = "5555";

	public void testprinterepson() throws UiObjectNotFoundException, RemoteException,
